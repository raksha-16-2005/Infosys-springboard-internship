...
public class AppointmentDTO {
    ...
    public PatientProfileDTO getPatient(){return patient;} public void setPatient(PatientProfileDTO p){this.patient=p;}
    public DoctorProfileDTO getDoctor(){return doctor;} public void setDoctor(DoctorProfileDTO d){this.doctor=d;}
