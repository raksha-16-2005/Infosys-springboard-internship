...
public class Appointment {
    public enum Status {SCHEDULED, ACCEPTED, REJECTED, RESCHEDULED, COMPLETED, CANCELLED, NO_SHOW}
    ...
    public void setDoctorRemarks(String r){this.doctorRemarks=r;}
    public LocalDateTime getRescheduledDate(){return rescheduledDate;}
    public void setRescheduledDate(LocalDateTime d){this.rescheduledDate=d;}
    ...
    public void setReminderSent(Boolean r){this.reminderSent=r;}
}
